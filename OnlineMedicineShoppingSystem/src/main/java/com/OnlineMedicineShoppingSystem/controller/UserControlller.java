...
public class UserControlller {
    ...
    public ResponseEntity<String> login(@RequestBody @Valid Users u){
        ...
        catch(Exception e){new ResponseEntity<String>(e.getMessage(),HttpStatus.CONFLICT);}
        return new ResponseEntity<String>("Login Unsuccessfull",HttpStatus.CONFLICT);
    }
    ...
    public ResponseEntity<List<Products>> products(){
        try{
        return new ResponseEntity<List<Products>>(productservice.fetchProducts(),HttpStatus.OK);
        }
        catch(Exception e){new ResponseEntity<String>(e.getMessage(),HttpStatus.CONFLICT);}
        return null;
    }
    ...
    public ResponseEntity<Object> viewcart(){
        try{
            if(login_status==false){new ResponseEntity<>("Login to view cart",HttpStatus.CONFLICT);}
            return new ResponseEntity<>(cartservice.fetchCartByUid(logedin_user.getUser_id()),HttpStatus.OK);
        }
        catch(Exception e){new ResponseEntity<>(e.getMessage(),HttpStatus.CONFLICT);}
        return null;
    }
    ...
    public ResponseEntity<Object> vieworder(){
        try{
            if(login_status==false){new ResponseEntity<>("Login to view orders",HttpStatus.CONFLICT);}
